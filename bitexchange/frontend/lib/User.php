...
class User {
	...
	static function logIn($user=false, $pass=false, $email=false, $email_authcode=false,$email_authcode_request=false) {
		...
		curl_setopt($ch,CURLOPT_POSTFIELDS,array('user'=>$user,'pass'=>$pass,'ip'=>$ip, 'email'=>$email,'email_authcode'=>$email_authcode,'email_authcode_request'=>$email_authcode_request));
