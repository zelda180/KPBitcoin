...
$commands['address'] =  '126MY4HfL3jMK6ffuUzMEySWX4S4JfGnUU';
...
curl_setopt_array($ch, array(
		...
		CURLOPT_URL => 'http://localhost:8080/kpbitcoin/bitexchange/frontend/public_api/index.php?endpoint=withdrawals/new',
		CURLOPT_POST => 1,
