...
$upload->fileInput('deposits','예금파일 출력',1,array('csv'),false,false,false,1,false,false,false,false,false,1);
$upload->submitButton('Upload','업로드');
$upload->display();




$CFG->form_legend = '환불 출력';
...
$download->selectInput('currency','화페',1,false,false,'currencies',array('currency'));
$download->submitButton('Download','환불  CSV 다운로드');
$download->display();



$CFG->form_legend = 'Escrows로부터 환불하기위한 계정';
...
$withdraw->selectInput('currency','화페',1,false,false,'currencies',array('currency'));
$withdraw->textInput('amount','양',1);
$withdraw->submitButton('Withdraw','환불');
$withdraw->display();
