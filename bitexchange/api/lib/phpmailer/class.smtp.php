...
class SMTP
{
    ...
    public function connect($host, $port = null, $timeout = 30, $options = array())
    {
        ...
        if ($this->connected()) {
            ...
            // trigger_error('Email could not be sent: Already connected to a server',E_USER_WARNING);
            return false;
        }
        ...
        if (empty($this->smtp_conn)) {
            ...
            // trigger_error('Email could not be sent: '.$errstr. $host . ":" . $port,E_USER_WARNING);
            return false;
        }
        if ($this->do_debug >= 3) {
