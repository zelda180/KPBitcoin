...
class Lang {
	...
	public static function url($url=false,$get_alts=false,$get_js=false) {
		...
		$urls['index.php']['kr'] = 'kr/index.php';
		...
		$urls['order-book.php']['kr'] = 'kr/'.urlencode('주문내역').'.php';
		...
		$urls['our-security.php']['kr'] = 'kr/'.urlencode('보안').'.php';
		...
		$urls['how-to-register.php']['kr'] = 'kr/'.urlencode('등록안내').'.php';
		...
		$urls['fee-schedule.php']['kr'] = 'kr/'.urlencode('수수료').'.php';
		...
		$urls['about.php']['kr'] = 'kr/'.urlencode('개요').'.php';
		...
		$urls['what-are-bitcoins.php']['kr'] = 'kr/'.urlencode('비트코인이란').'.php';
		...
		$urls['how-bitcoin-works.php']['kr'] = 'kr/'.urlencode('비트코인작동원리').'.php';
		...
		$urls['reset_2fa.php']['kr'] = 'kr/'.urlencode('2fa재설정').'.php';
		...
		$urls['news.php']['kr'] = 'kr/'.urlencode('뉴스').'.php';
		...
		$urls['terms.php']['kr'] = 'kr/'.urlencode('용어').'.php';
