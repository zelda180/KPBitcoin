...
<head>
	...
	<meta name="publisher" content="KPBitcoin" />
            ...
            <ul class="tci_list">
                ...
                <li class="empty margin-left">
                	...
                	<select id="language_selector" class="lang">
                		...
                		<option value="kr" <?= ($CFG->language == 'kr') ? 'selected="selected"' : '' ?>>한국어</option>
                	</select>
                </li>
            </ul>
           ...
           <nav id="access" class="access" role="navigation">
            ...
            <div id="menu" class="menu">
                ...
                <ul id="tiny">
                    ...
                    <li><a href="send-krw.php" <?= ($CFG->self == 'send-krw.php') ? 'class="active"' : '' ?>><?= Lang::string('send') ?></a></li>
